...
void Rooftop::Initialize()
{
    ...
    m_droneManager->SpawnDrone({ 8700.0f, 1700.0f }, "Asset/Drone.png", DroneType::General);
    m_droneManager->SpawnDrone({ 13500.0f, 1900.0f }, "Asset/Drone.png", DroneType::General);
    m_droneManager->SpawnDrone({ 14500.0f, 1750.0f }, "Asset/Drone.png", DroneType::Detection);
    m_droneManager->SpawnDrone({ 15500.0f, 1700.0f }, "Asset/Drone.png", DroneType::General);
    m_droneManager->SpawnDrone({ 17250.0f, 1800.0f }, "Asset/Drone.png", DroneType::General);
