#include "Input.hpp"
#include <GLFW/glfw3.h> // Input.cpp만 GLFW 헤더를 포함합니다.

// 모든 함수 구현을 Input 네임스페이스 안에 둡니다.
namespace Input
{
    void Input::Initialize(GLFWwindow* window)
    {
        m_window = window;
        // GLFW_KEY_LAST가 348이므로, 349 크기 배열을 사용합니다.
    ...
    void Input::Update()
    {
        ...
        // 0부터 348 (GLFW_KEY_LAST)까지 모든 키의 상태를 폴링합니다.
